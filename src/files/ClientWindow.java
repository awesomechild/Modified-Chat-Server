...
public class ClientWindow extends JFrame implements Runnable {
	...
	public ClientWindow(String name, String address, int port) {
		...
		// run thread creates the listen thread
	...
	private void createWindow() {
		...
		mntmOnlineUsers.setFont(new Font("Jamrul", Font.BOLD, 16));
		...
		mntmExit.setFont(new Font("Dialog", Font.BOLD, 16));
		mnFile.add(mntmExit);
		...
		txtMessage.setFont(new Font("Dialog", Font.PLAIN, 16));
